...
echo "Help me, Obi-Wan... You're my only hope." > princess.leia.txt
...
sudo mv luke_skywalker.txt obi_wan.txt princess.leia.txt ./millenium_falcon 
# 7. Move the millenium_falcon into the death_star.
sudo mv ./millenium_falcon ./empire/death_star